/*
 * File: C:\user\vranken\projects\comFrameworkAtSourceforge\codeGenerator\trunk\samples\EmbeddedCoderAPIWithBusStruct\slprj\ert\_sharedutils\mul_wide_su32.c
 *
