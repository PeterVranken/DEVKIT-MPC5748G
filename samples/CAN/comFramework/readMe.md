...
# comFramework 1.4 (r298, 12.09.2018) #
...
- The [download page](https://sourceforge.net/p/comframe/files) at SourceForge provides a ZIP archive for download,
  ...
  folder structure. The archive contains the files of revision r298
  (12.09.2018 22:48:42) of the SourceForge [SVN repository](https://sourceforge.net/p/comframe/code/HEAD/tree)
...
As of today, September 2018, we have the following discussions in the Wiki
pages:
