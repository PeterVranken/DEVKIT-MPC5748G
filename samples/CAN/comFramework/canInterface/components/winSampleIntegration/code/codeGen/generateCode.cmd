...
call codeGenerator ^
  ...
  --output-file-name cst_canStatistics.h ^
    --template-file-name cbk_callbacks/cst_canStatistics.h.stg ^
    --template-name canStatistics_h ^
  --output-file-name targetLinkDDPool.extended.xml ^
    --template-file-name cbk_callbacks/targetLinkDDPool.extended.xml.stg ^
