...
generates C code from this model. The generated code is part of the
sample; the code generation can be reproduced with MATLAB 2009b. __Delete
the folders__ pwr\_computeEnginePower\_ert\_rtw and slpr, then open the
model pwr\_computeEnginePower.mdl and type Ctrl-B. Note, MATLAB is a non
open source tool and the code generation requires a licence. If you don't
have MATLAB then you will find the generated C code in the folders
pwr\_computeEnginePower\_ert\_rtw and slprj.
