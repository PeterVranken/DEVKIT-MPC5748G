...
srcDirList += code/rtos/rtosConfig/ ../canInterface/code/ code/codeGen/ code/integration/   \
              code/APSW/ code/APSW/pwr_computeEnginePower_ert_rtw/                          \
              code/APSW/slprj/ert/_sharedutils/                                             \
              code/canShield/
