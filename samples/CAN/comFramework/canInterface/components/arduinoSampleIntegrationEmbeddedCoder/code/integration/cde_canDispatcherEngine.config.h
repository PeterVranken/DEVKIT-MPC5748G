...
typedef uint8_t cde_osHandleFrame_t;
...
#define CDE_COMMON_MACHINE_ALIGNMENT 1
...
typedef uint8_t cde_atomicUnsignedInt_t;
...
/** Some few pieces of code require mutual exclusion of the APSW tasks and the interrupts,
    ...
    consideration.
      Arduino integration: We follow this recommendation and don't define the macro. */
...
#define CDE_ENABLE_API_GET_INDEX_BUS            0
...
/** Tailoring of the API: The timer context data is not always required and can be switched
    ...
    it, please refer to cde_getHandleTimer().\n
      The define is set to either 1 or 0. */
#define CDE_ENABLE_TIMER_CONTEXT_DATA           0
