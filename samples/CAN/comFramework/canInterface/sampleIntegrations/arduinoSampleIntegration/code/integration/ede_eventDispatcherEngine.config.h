...
typedef uint8_t ede_kindOfEvent_t;
...
typedef uint8_t ede_senderHandleEvent_t;
...
#define EDE_COMMON_MACHINE_ALIGNMENT 1
...
typedef uint8_t ede_atomicUnsignedInt_t;
...
#define EDE_ENABLE_TIMER_CONTEXT_DATA               0
