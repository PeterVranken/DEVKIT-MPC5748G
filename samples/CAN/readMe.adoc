...
PWM.dbc. The CAN message PWM_out has signals to set frequency and duty
cycle of the connected PWM channels and there is a Boolean switch to
between CAN control and control via command line otherwise.

The effect is best if the PWM output PA1, on extension port J3, pin 1 is
