...
excelExporter ^
  ...
  --input-file-name "canComSpec.xlsx" ^
    ...
    --open-worksheet-selection ^
      --worksheet-by-tab "Sample_DBC" ^
      --worksheet-name frames ^
      --applied-worksheet-template wshTmplDBC ^
    --user-option-name ECU --user-option-value ECU ^
  --open-worksheet-template ^
    --worksheet-template-name wshTmplDBC ^
    --column-titles-are-identifiers ^
    --index-title-row 1 ^
    -ca -ct Frame --is-grouping-column -soc lexical ^
    -ca -ct Signal --is-grouping-column -soc lexical ^
    -ca -ct SignalValueName --is-grouping-column ^
    -ca -ct InitialValue -soc numerical ^
