...
excelExporter ^
  ...
  --open-worksheet-template ^
    --association-by-tab ".*(CAN|DBC).*" ^
    --index-title-row 1 ^
    -ca -ct Frame -cn Frame --is-grouping-column ^
    -ca -cn StartBit --column-title "Start Bit" ^
    -ca -ct Name -soc lexical ^
    --group DBC ^
  --open-worksheet-template ^
    --association-by-tab "Signal values.*" ^
    -ca -ci 1 --is-grouping-column -soc lexical ^
    -ca -ci 2 --is-grouping-column -soc numerical ^
    --group signalValues ^
