...
extern unsigned int bsw_cpuLoad;
...
/** Application provided Ethernet task function, running in user process bsw_pidUser. */
extern void bsw_taskEthernet( unsigned int noNotificationsRx
