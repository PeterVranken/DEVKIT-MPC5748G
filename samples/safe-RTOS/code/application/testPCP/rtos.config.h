...
#define RTOS_RUN_SAFE_RTOS_ON_CORE_1_Z4B    0
...
/** The MPC5748G has 16 PIT timer channels, which can be used to clock the RTOS. The choice
    ...
    purposes and not each timer can dtrive each I/O device. Each core uses its own timer.\n
...
/// @todo Have _Static_assert to check range and duplications and avoidance of 0.
