...
/** Specify whether core 1, Z4B, should run safe-RTOS. Permitted values are 1 or 0.\n
      This particular sample application of safe-RTOS offers to chose, which secondary core
...
#define RTOS_KERNEL_IRQ_PRIORITY_CORE_1         12
...
/** Any user task is activated by an event, which is notified to an event processor.
    ...
    cores. */
#define RTOS_MAX_NO_EVENT_PROCESSORS            8
