...
- https://petervranken.github.io/MPC5748GAtGitHub/samples/safe-RTOS/doc/manual/manual.html[The
...
- The API documentation is available as
  https://petervranken.github.io/MPC5748GAtGitHub/samples/safe-RTOS/doc/doxygen/[Doxygen
  online help^].
