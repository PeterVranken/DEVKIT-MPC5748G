...
# connection.
."$env:S32DS_HOME\eclipse\plugins\com.pemicro.debug.gdbjtag.ppc_1.8.3.201812312131\win32\pegdbserver_power_console.exe" -device=MPC5748g -startserver -serverport=7224 -gdbmport=6224 -interface=OPENSDA -speed=5000 -port= -verbose