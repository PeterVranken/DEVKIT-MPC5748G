...
void *sbrk(ptrdiff_t increment)
{
    ...
    static mtx_mutex_t mutex_ = MTX_MUTEX_INITIALLY_RELEASED;
 ...
 */
int fstat(int fildes TYP_UNUSED, struct stat *buf TYP_UNUSED)
{
    return -1;
 ...
 */
int isatty(int fildes TYP_UNUSED)
{
    assert(false);
    return 1;
 ...
 */
int close(int fildes TYP_UNUSED)
{
    assert(false);
    return 0;
 ...
 */
off_t lseek(int fildes TYP_UNUSED, off_t offset TYP_UNUSED, int whence TYP_UNUSED)
{
    assert(false);
    return -1;
 ...
 */
ssize_t read(int fildes TYP_UNUSED, void *buf TYP_UNUSED, size_t nbytes TYP_UNUSED)
{
    assert(false);
    return -1;
